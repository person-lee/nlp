...
public class TextRankSummary
{
    ...
    public TextRankSummary(List<List<String>> docs)
    {
        ...
        vertex = new double[D];
        top = Maps.newTreeMap(Collections.reverseOrder());
        solve();
    }
	...
	public static boolean shouldInclude(Term term) {
		if (term.getNatureStr().startsWith("n")
			...
			if (StringUtils.isNoneBlank(StringUtil.removeSpecialChars(term.getName()))) {
				return true;
			}
		}
    ...
    public static List<String> getTopSentenceList(String document, int size)
    {
        ...
        List<List<String>> docs = Lists.newArrayList();
