package com.lbc.nlp_algorithm.clustering.kmeans;

import java.io.IOException;
import java.util.*;
import java.util.Map.Entry;

import com.lbc.nlp_algorithm.word2vec.Word2VEC;
...
public class Kmeans {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vec.loadJavaModel("F://word2vec/SogouCS/Multi/SogouCS");
        System.out.println("load model ok!");
        Kmeans wordKmeans = new Kmeans(vec.getWordMap(), 50, 50);
    ...
    public Kmeans(HashMap<String, float[]> wordMap, int clcn, int iter) {
