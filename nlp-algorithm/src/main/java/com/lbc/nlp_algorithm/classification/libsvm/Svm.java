...
public class Svm {
	...
	private static void svm_binary_svc_probability(SvmProblem prob, SvmParameter param, double Cp, double Cn, double[] probAB) throws CloneNotSupportedException {
		int i;
		int nr_fold = 5;
	...
	private static double svm_svr_probability(SvmProblem prob, SvmParameter param) throws CloneNotSupportedException {
		int i;
		int nr_fold = 5;
	...
	// Interface functions
	//
	public static SvmModel svm_train(SvmProblem prob, SvmParameter param) throws CloneNotSupportedException {
	...
	public static void svm_cross_validation(SvmProblem prob, SvmParameter param, int nr_fold, double[] target) throws CloneNotSupportedException {
		int i;
